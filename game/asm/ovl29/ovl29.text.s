...
glabel func_ovl29_80133410
  ...
  /* 14945C 8013342C 3C03800A */       lui $v1, %hi((D_800A44E0 + 0x46C))
  /* 149460 80133430 006F1821 */      addu $v1, $v1, $t7
  /* 149464 80133434 8C63494C */        lw $v1, %lo((D_800A44E0 + 0x46C))($v1)
...
glabel func_ovl29_80133990
  ...
  /* 1499DC 801339AC 3C02800A */       lui $v0, %hi((D_800A44E0 + 0x470))
  /* 1499E0 801339B0 004F1021 */      addu $v0, $v0, $t7
  /* 1499E4 801339B4 03E00008 */        jr $ra
  /* 1499E8 801339B8 90424950 */       lbu $v0, %lo((D_800A44E0 + 0x470))($v0)
...
glabel func_ovl29_80133B7C
  ...
  /* 149BC8 80133B98 3C02800A */       lui $v0, %hi((D_800A44E0 + 0x470))
  /* 149BCC 80133B9C 004F1021 */      addu $v0, $v0, $t7
  /* 149BD0 80133BA0 10000003 */         b .L80133BB0
  /* 149BD4 80133BA4 90424950 */       lbu $v0, %lo((D_800A44E0 + 0x470))($v0)
  .L80133BA8:
...
glabel func_ovl29_80136B54
  ...
  /* 14CBA8 80136B78 3C19800A */       lui $t9, %hi((D_800A4AD0 + 0x13))
  /* 14CBAC 80136B7C 93394AE3 */       lbu $t9, %lo((D_800A4AD0 + 0x13))($t9)
  ...
  /* 14CBF4 80136BC4 3C0A800A */       lui $t2, %hi((D_800A44E0 + 0x458))
  /* 14CBF8 80136BC8 954A4938 */       lhu $t2, %lo((D_800A44E0 + 0x458))($t2)
...
glabel func_ovl29_80136CD8
  ...
  /* 14CEF0 80136EC0 3C0C800A */       lui $t4, %hi((D_800A4AD0 + 0x1))
  /* 14CEF4 80136EC4 918C4AD1 */       lbu $t4, %lo((D_800A4AD0 + 0x1))($t4)
