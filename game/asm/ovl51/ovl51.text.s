...
glabel func_ovl51_8018D0C0
  ...
  /* 174990 8018D110 0C0337DE */       jal func_ovl0_800CDF78
  ...
  /* 1749A0 8018D120 0C0337BB */       jal func_ovl0_800CDEEC
  /* 1749A4 8018D124 24050002 */     addiu $a1, $zero, 2
  /* 1749A8 8018D128 00402025 */        or $a0, $v0, $zero
  /* 1749AC 8018D12C 0C001260 */       jal func_80004980
  ...
  /* 1749C8 8018D148 0C033781 */       jal func_ovl0_800CDE04
...
glabel func_ovl51_8018D168
  ...
  /* 174B34 8018D2B4 0C002062 */       jal func_80008188
...
glabel func_ovl51_8018D2DC
  ...
  .L8018D328:
  /* 174BA8 8018D328 0C008D89 */       jal func_80023624
  /* 174BAC 8018D32C 02002025 */        or $a0, $s0, $zero
  /* 174BB0 8018D330 0C028C10 */       jal func_800A3040
  ...
  .L8018D370:
  /* 174BF0 8018D370 0C008D89 */       jal func_80023624
  /* 174BF4 8018D374 02002025 */        or $a0, $s0, $zero
  /* 174BF8 8018D378 0C028C10 */       jal func_800A3040
  ...
  /* 174C60 8018D3E0 3C15800A */       lui $s5, %hi(D_800A50E8)
  /* 174C64 8018D3E4 26B550E8 */     addiu $s5, $s5, %lo(D_800A50E8)
  ...
  /* 174CBC 8018D43C 8EAB0000 */        lw $t3, ($s5) # D_800A50E8 + 0
  /* 174CC0 8018D440 3C0E8004 */       lui $t6, %hi(D_80045228)
  /* 174CC4 8018D444 25CE5228 */     addiu $t6, $t6, %lo(D_80045228)
  ...
  /* 174CE8 8018D468 8EA20000 */        lw $v0, ($s5) # D_800A50E8 + 0
  ...
  /* 174DB0 8018D530 8EA90000 */        lw $t1, ($s5) # D_800A50E8 + 0
  ...
  /* 174DF0 8018D570 8EAD0000 */        lw $t5, ($s5) # D_800A50E8 + 0
...
glabel func_ovl51_8018D5E4
  ...
  /* 174E94 8018D614 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 174E98 8018D618 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 174E9C 8018D61C 90580000 */       lbu $t8, ($v0) # D_800A4AD0 + 0
  /* 174EA0 8018D620 A0590000 */        sb $t9, ($v0) # D_800A4AD0 + 0
  /* 174EA4 8018D624 0C00171D */       jal func_80005C74
  /* 174EA8 8018D628 A0580001 */        sb $t8, 1($v0) # D_800A4AD0 + 1
  .L8018D62C:
  /* 174EAC 8018D62C 3C088019 */       lui $t0, %hi(D_ovl51_8018DA48)
  /* 174EB0 8018D630 8D08DA48 */        lw $t0, %lo(D_ovl51_8018DA48)($t0)
  /* 174EB4 8018D634 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 174EB8 8018D638 24010140 */     addiu $at, $zero, 0x140
  /* 174EBC 8018D63C 15010006 */       bne $t0, $at, .L8018D658
  /* 174EC0 8018D640 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 174EC4 8018D644 90490000 */       lbu $t1, ($v0) # D_800A4AD0 + 0
  /* 174EC8 8018D648 240A0027 */     addiu $t2, $zero, 0x27
  /* 174ECC 8018D64C A04A0000 */        sb $t2, ($v0) # D_800A4AD0 + 0
  /* 174ED0 8018D650 0C00171D */       jal func_80005C74
  /* 174ED4 8018D654 A0490001 */        sb $t1, 1($v0) # D_800A4AD0 + 1
  .L8018D658:
...
glabel func_ovl51_8018D670
  ...
  /* 174F54 8018D6D4 AC440000 */        sw $a0, ($v0) # D_800A50E8 + 0
  ...
  /* 174F88 8018D708 0C00265A */       jal func_80009968
  ...
  /* 174FEC 8018D76C 0C05952C */       jal func_ovl3_801654B0
  /* 174FF0 8018D770 00000000 */       nop 
  /* 174FF4 8018D774 0C05B7A8 */       jal func_ovl3_8016DEA0
  /* 174FF8 8018D778 00000000 */       nop 
  /* 174FFC 8018D77C 0C03F4C0 */       jal func_ovl2_800FD300
...
glabel func_ovl51_8018D7CC
  ...
  /* 17506C 8018D7EC 3C058013 */       lui $a1, %hi(D_ovl2_80131390)
  /* 175070 8018D7F0 3C068013 */       lui $a2, %hi(D_ovl2_80131394)
  /* 175074 8018D7F4 AC780004 */        sw $t8, 4($v1)
  /* 175078 8018D7F8 AC6F0000 */        sw $t7, ($v1)
  /* 17507C 8018D7FC 8CC61394 */        lw $a2, %lo(D_ovl2_80131394)($a2)
  /* 175080 8018D800 0C03F2DC */       jal func_ovl2_800FCB70
  /* 175084 8018D804 8CA51390 */        lw $a1, %lo(D_ovl2_80131390)($a1)
