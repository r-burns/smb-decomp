...
glabel func_ovl12_800D64A0
  /* 119E00 800D64A0 3C0E8004 */       lui $t6, %hi(D_80045472)
  /* 119E04 800D64A4 95CE5472 */       lhu $t6, %lo(D_80045472)($t6)
  ...
  /* 119E78 800D6518 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 119E7C 800D651C 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 119E80 800D6520 904A0000 */       lbu $t2, ($v0) # D_800A4AD0 + 0
  /* 119E84 800D6524 312300FF */      andi $v1, $t1, 0xff
  /* 119E88 800D6528 28610011 */      slti $at, $v1, 0x11
  /* 119E8C 800D652C A049000F */        sb $t1, 0xf($v0) # D_800A4AD0 + 15
  /* 119E90 800D6530 14200016 */      bnez $at, .L800D658C
  /* 119E94 800D6534 A04A0001 */        sb $t2, 1($v0) # D_800A4AD0 + 1
  ...
  /* 119EE8 800D6588 A0580000 */        sb $t8, ($v0) # D_800A4AD0 + 0
  .L800D658C:
  /* 119EEC 800D658C 24190016 */     addiu $t9, $zero, 0x16
  /* 119EF0 800D6590 A0590000 */        sb $t9, ($v0) # D_800A4AD0 + 0
  .L800D6594:
...
glabel func_ovl12_800D65AC
  ...
  /* 119F24 800D65C4 0C00265A */       jal func_80009968
