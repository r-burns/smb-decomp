...
glabel func_ovl14_80131B58
  ...
  /* 11B9E8 80131B78 3C04800A */       lui $a0, %hi(D_800A4D2A)
  /* 11B9EC 80131B7C 90844D2A */       lbu $a0, %lo(D_800A4D2A)($a0)
  /* 11B9F0 80131B80 3C03800A */       lui $v1, %hi(D_800A4D9E)
  /* 11B9F4 80131B84 3C01800A */       lui $at, %hi(D_800A4D2C)
  ...
  .L80131BB4:
  /* 11BA24 80131BB4 A0204D2C */        sb $zero, %lo(D_800A4D2C)($at)
  /* 11BA28 80131BB8 3C01800A */       lui $at, %hi(D_800A4D30)
  /* 11BA2C 80131BBC A0204D30 */        sb $zero, %lo(D_800A4D30)($at)
  /* 11BA30 80131BC0 3C01800A */       lui $at, %hi(D_800A4D32)
  /* 11BA34 80131BC4 A0204D32 */        sb $zero, %lo(D_800A4D32)($at)
  /* 11BA38 80131BC8 90634D9E */       lbu $v1, %lo(D_800A4D9E)($v1)
  /* 11BA3C 80131BCC 3C01800A */       lui $at, %hi(D_800A4DA0)
  ...
  .L80131C08:
  /* 11BA78 80131C08 A0264DA0 */        sb $a2, %lo(D_800A4DA0)($at)
  /* 11BA7C 80131C0C 3C01800A */       lui $at, %hi(D_800A4DA4)
  /* 11BA80 80131C10 A0264DA4 */        sb $a2, %lo(D_800A4DA4)($at)
  /* 11BA84 80131C14 3C01800A */       lui $at, %hi(D_800A4DA6)
  /* 11BA88 80131C18 A0264DA6 */        sb $a2, %lo(D_800A4DA6)($at)
  /* 11BA8C 80131C1C 3C03800A */       lui $v1, %hi(D_800A4E12)
  /* 11BA90 80131C20 90634E12 */       lbu $v1, %lo(D_800A4E12)($v1)
  /* 11BA94 80131C24 3C01800A */       lui $at, %hi(D_800A4E14)
  ...
  .L80131C60:
  /* 11BAD0 80131C60 A02F4E14 */        sb $t7, %lo(D_800A4E14)($at)
  /* 11BAD4 80131C64 3C01800A */       lui $at, %hi(D_800A4E18)
  /* 11BAD8 80131C68 A0384E18 */        sb $t8, %lo(D_800A4E18)($at)
  /* 11BADC 80131C6C 3C01800A */       lui $at, %hi(D_800A4E1A)
  /* 11BAE0 80131C70 A0394E1A */        sb $t9, %lo(D_800A4E1A)($at)
  /* 11BAE4 80131C74 3C03800A */       lui $v1, %hi(D_800A4E86)
  /* 11BAE8 80131C78 90634E86 */       lbu $v1, %lo(D_800A4E86)($v1)
  /* 11BAEC 80131C7C 3C01800A */       lui $at, %hi(D_800A4E88)
  ...
  .L80131CB8:
  /* 11BB28 80131CB8 A02C4E88 */        sb $t4, %lo(D_800A4E88)($at)
  /* 11BB2C 80131CBC 3C01800A */       lui $at, %hi(D_800A4E8C)
  /* 11BB30 80131CC0 A02D4E8C */        sb $t5, %lo(D_800A4E8C)($at)
  /* 11BB34 80131CC4 3C01800A */       lui $at, %hi(D_800A4E8E)
  /* 11BB38 80131CC8 240E0003 */     addiu $t6, $zero, 3
  /* 11BB3C 80131CCC A02E4E8E */        sb $t6, %lo(D_800A4E8E)($at)
...
glabel func_ovl14_80131E38
  ...
  /* 11BCB4 80131E44 3C11800A */       lui $s1, %hi(D_800A4938)
  /* 11BCB8 80131E48 96314938 */       lhu $s1, %lo(D_800A4938)($s1)
  /* 11BCBC 80131E4C 3C10800A */       lui $s0, %hi(D_800A4AD0)
  /* 11BCC0 80131E50 26104AD0 */     addiu $s0, $s0, %lo(D_800A4AD0)
  /* 11BCC4 80131E54 960E000A */       lhu $t6, 0xa($s0) # D_800A4AD0 + 10
  ...
  /* 11BCD8 80131E68 A600000A */        sh $zero, 0xa($s0) # D_800A4AD0 + 10
  .L80131E6C:
  ...
  /* 11BCEC 80131E7C 9604000A */       lhu $a0, 0xa($s0) # D_800A4AD0 + 10
  /* 11BCF0 80131E80 8FAF0024 */        lw $t7, 0x24($sp)
  /* 11BCF4 80131E84 0C006265 */       jal func_80018994
  /* 11BCF8 80131E88 01E22023 */      subu $a0, $t7, $v0
  /* 11BCFC 80131E8C 3224FFFF */      andi $a0, $s1, 0xffff
  /* 11BD00 80131E90 9605000A */       lhu $a1, 0xa($s0) # D_800A4AD0 + 10
  /* 11BD04 80131E94 0C04C77B */       jal func_ovl14_80131DEC
  /* 11BD08 80131E98 00403025 */        or $a2, $v0, $zero
  /* 11BD0C 80131E9C 9603000A */       lhu $v1, 0xa($s0) # D_800A4AD0 + 10
  /* 11BD10 80131EA0 A202000D */        sb $v0, 0xd($s0) # D_800A4AD0 + 13
  /* 11BD14 80131EA4 54600003 */      bnel $v1, $zero, .L80131EB4
  /* 11BD18 80131EA8 9219000D */       lbu $t9, 0xd($s0) # D_800A4AD0 + 13
  /* 11BD1C 80131EAC A202000C */        sb $v0, 0xc($s0) # D_800A4AD0 + 12
  /* 11BD20 80131EB0 9219000D */       lbu $t9, 0xd($s0) # D_800A4AD0 + 13
  .L80131EB4:
  ...
  /* 11BD38 80131EC8 A60A000A */        sh $t2, 0xa($s0) # D_800A4AD0 + 10
  /* 11BD3C 80131ECC AFA20024 */        sw $v0, 0x24($sp)
  /* 11BD40 80131ED0 0C04C75D */       jal func_ovl14_80131D74
  /* 11BD44 80131ED4 9604000A */       lhu $a0, 0xa($s0) # D_800A4AD0 + 10
  ...
  /* 11BD58 80131EE8 920C000C */       lbu $t4, 0xc($s0) # D_800A4AD0 + 12
  /* 11BD5C 80131EEC 1000000E */         b .L80131F28
  /* 11BD60 80131EF0 A20C000E */        sb $t4, 0xe($s0) # D_800A4AD0 + 14
  .L80131EF4:
  /* 11BD64 80131EF4 0C006265 */       jal func_80018994
  /* 11BD68 80131EF8 00000000 */       nop 
  /* 11BD6C 80131EFC 3224FFFF */      andi $a0, $s1, 0xffff
  /* 11BD70 80131F00 9605000A */       lhu $a1, 0xa($s0) # D_800A4AD0 + 10
  /* 11BD74 80131F04 0C04C77B */       jal func_ovl14_80131DEC
  /* 11BD78 80131F08 00403025 */        or $a2, $v0, $zero
  /* 11BD7C 80131F0C 960D000A */       lhu $t5, 0xa($s0) # D_800A4AD0 + 10
  ...
  /* 11BD90 80131F20 A202000E */        sb $v0, 0xe($s0) # D_800A4AD0 + 14
  /* 11BD94 80131F24 A608000A */        sh $t0, 0xa($s0) # D_800A4AD0 + 10
  .L80131F28:
...
glabel func_ovl14_80131F3C
  ...
  /* 11BDB0 80131F40 3C0E8004 */       lui $t6, %hi(D_80045472)
  /* 11BDB4 80131F44 95CE5472 */       lhu $t6, %lo(D_80045472)($t6)
  ...
  /* 11BEEC 8013207C 0C035FCF */       jal func_ovl2_800D7F3C
  ...
  /* 11BF4C 801320DC 3C028004 */       lui $v0, %hi(D_80045472)
  /* 11BF50 801320E0 94425472 */       lhu $v0, %lo(D_80045472)($v0)
  ...
  /* 11BF80 80132110 3C028004 */       lui $v0, %hi(D_80045472)
  /* 11BF84 80132114 94425472 */       lhu $v0, %lo(D_80045472)($v0)
  .L80132118:
  ...
  /* 11BFC8 80132158 3C10800A */       lui $s0, %hi(D_800A4AD0)
  /* 11BFCC 8013215C 26104AD0 */     addiu $s0, $s0, %lo(D_800A4AD0)
  /* 11BFD0 80132160 920F0000 */       lbu $t7, ($s0) # D_800A4AD0 + 0
  /* 11BFD4 80132164 3C188013 */       lui $t8, %hi(D_ovl14_80132694)
  /* 11BFD8 80132168 A20F0001 */        sb $t7, 1($s0) # D_800A4AD0 + 1
  ...
  /* 11C008 80132198 A2190000 */        sb $t9, ($s0) # D_800A4AD0 + 0
  ...
  /* 11C020 801321B0 A2080000 */        sb $t0, ($s0) # D_800A4AD0 + 0
  /* 11C024 801321B4 A2000013 */        sb $zero, 0x13($s0) # D_800A4AD0 + 19
  /* 11C028 801321B8 A2090014 */        sb $t1, 0x14($s0) # D_800A4AD0 + 20
  /* 11C02C 801321BC 10000014 */         b .L80132210
  /* 11C030 801321C0 A20E0015 */        sb $t6, 0x15($s0) # D_800A4AD0 + 21
  glabel jtgt_ovl14_801321C4
  /* 11C034 801321C4 240A0038 */     addiu $t2, $zero, 0x38
  /* 11C038 801321C8 10000011 */         b .L80132210
  /* 11C03C 801321CC A20A0000 */        sb $t2, ($s0) # D_800A4AD0 + 0
  ...
  /* 11C04C 801321DC A20D0000 */        sb $t5, ($s0) # D_800A4AD0 + 0
  ...
  /* 11C06C 801321FC A20B0000 */        sb $t3, ($s0) # D_800A4AD0 + 0
  ...
  /* 11C07C 8013220C A20C0000 */        sb $t4, ($s0) # D_800A4AD0 + 0
  .L80132210:
...
glabel func_ovl14_8013239C
  ...
  /* 11C29C 8013242C 0C00265A */       jal func_80009968
  ...
  /* 11C2B4 80132444 0C002062 */       jal func_80008188
  ...
  /* 11C2E8 80132478 0C03F4C0 */       jal func_ovl2_800FD300
  ...
  /* 11C3F0 80132580 0C001260 */       jal func_80004980
  /* 11C3F4 80132584 E7AA005C */      swc1 $f10, 0x5c($sp)
  /* 11C3F8 80132588 AFA20090 */        sw $v0, 0x90($sp)
  /* 11C3FC 8013258C 0C035FCF */       jal func_ovl2_800D7F3C
