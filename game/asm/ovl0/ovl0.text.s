...
glabel func_ovl0_800D46F4
  ...
  /* 0500DC 800D46FC 3C04800A */       lui $a0, %hi((D_800A44E0 + 0x451))
  /* 0500E0 800D4700 0C00828D */       jal func_80020A34
  /* 0500E4 800D4704 90844931 */       lbu $a0, %lo((D_800A44E0 + 0x451))($a0)
...
glabel func_ovl0_800D49E0
  ...
  /* 0503C8 800D49E8 3C05800A */       lui $a1, %hi((D_800A44E0 + 0x5C))
  /* 0503CC 800D49EC 3C06800A */       lui $a2, %hi(D_800A39F0)
  /* 0503D0 800D49F0 3C07800A */       lui $a3, %hi((D_800A44E0 + 0xB8))
  /* 0503D4 800D49F4 3C08800A */       lui $t0, %hi(D_800A3A4C)
  /* 0503D8 800D49F8 3C09800A */       lui $t1, %hi((D_800A44E0 + 0x114))
  ...
  /* 0503EC 800D4A0C 252945F4 */     addiu $t1, $t1, %lo((D_800A44E0 + 0x114))
  /* 0503F0 800D4A10 25083A4C */     addiu $t0, $t0, %lo(D_800A3A4C)
  /* 0503F4 800D4A14 24E74598 */     addiu $a3, $a3, %lo((D_800A44E0 + 0xB8))
  /* 0503F8 800D4A18 24C639F0 */     addiu $a2, $a2, %lo(D_800A39F0)
  /* 0503FC 800D4A1C 24A5453C */     addiu $a1, $a1, %lo((D_800A44E0 + 0x5C))
  ...
  /* 050534 800D4B54 3C01800A */       lui $at, %hi((D_800A44E0 + 0x5e0))
  /* 050538 800D4B58 03E00008 */        jr $ra
  /* 05053C 800D4B5C A42E4AC0 */        sh $t6, %lo((D_800A44E0 + 0x5e0))($at)
