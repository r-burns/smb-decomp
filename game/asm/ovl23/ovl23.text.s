...
glabel func_ovl23_80131B24
  /* 12A4E4 80131B24 3C038004 */       lui $v1, %hi(D_800465B0)
  /* 12A4E8 80131B28 246365B0 */     addiu $v1, $v1, %lo(D_800465B0)
  /* 12A4EC 80131B2C 8C620000 */        lw $v0, ($v1) # D_800465B0 + 0
  ...
  /* 12A520 80131B60 AC6F0000 */        sw $t7, ($v1) # D_800465B0 + 0
  /* 12A524 80131B64 AC400004 */        sw $zero, 4($v0)
  /* 12A528 80131B68 AC580000 */        sw $t8, ($v0)
  /* 12A52C 80131B6C 8C620000 */        lw $v0, ($v1) # D_800465B0 + 0
  ...
  /* 12A53C 80131B7C AC790000 */        sw $t9, ($v1) # D_800465B0 + 0
  /* 12A540 80131B80 AC4F0004 */        sw $t7, 4($v0)
  /* 12A544 80131B84 AC4E0000 */        sw $t6, ($v0)
  /* 12A548 80131B88 8C620000 */        lw $v0, ($v1) # D_800465B0 + 0
  ...
  /* 12A558 80131B98 AC780000 */        sw $t8, ($v1) # D_800465B0 + 0
  ...
  /* 12A56C 80131BAC 8C620000 */        lw $v0, ($v1) # D_800465B0 + 0
  ...
  /* 12A57C 80131BBC AC6F0000 */        sw $t7, ($v1) # D_800465B0 + 0
  ...
  /* 12A590 80131BD0 8C620000 */        lw $v0, ($v1) # D_800465B0 + 0
  ...
  /* 12A5A0 80131BE0 AC790000 */        sw $t9, ($v1) # D_800465B0 + 0
  ...
  /* 12A5B4 80131BF4 8C620000 */        lw $v0, ($v1) # D_800465B0 + 0
  ...
  /* 12A5C4 80131C04 AC780000 */        sw $t8, ($v1) # D_800465B0 + 0
  /* 12A5C8 80131C08 AC400004 */        sw $zero, 4($v0)
  /* 12A5CC 80131C0C AC4D0000 */        sw $t5, ($v0)
  /* 12A5D0 80131C10 8C620000 */        lw $v0, ($v1) # D_800465B0 + 0
  /* 12A5D4 80131C14 24590008 */     addiu $t9, $v0, 8
  /* 12A5D8 80131C18 AC790000 */        sw $t9, ($v1) # D_800465B0 + 0
...
glabel func_ovl23_80131E3C
  ...
  /* 12A8FC 80131F3C 0C03A605 */       jal func_ovl2_800E9814
...
glabel func_ovl23_80132118
  ...
  /* 12AB50 80132190 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 12AB54 80132194 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 12AB58 80132198 90480000 */       lbu $t0, ($v0) # D_800A4AD0 + 0
  /* 12AB5C 8013219C A0490000 */        sb $t1, ($v0) # D_800A4AD0 + 0
  /* 12AB60 801321A0 0C04C844 */       jal func_ovl23_80132110
  /* 12AB64 801321A4 A0480001 */        sb $t0, 1($v0) # D_800A4AD0 + 1
...
glabel func_ovl23_801321C0
  ...
  /* 12ABD0 80132210 0C0337DE */       jal func_ovl0_800CDF78
  ...
  /* 12ABE0 80132220 0C0337BB */       jal func_ovl0_800CDEEC
  /* 12ABE4 80132224 24050001 */     addiu $a1, $zero, 1
  /* 12ABE8 80132228 00402025 */        or $a0, $v0, $zero
  /* 12ABEC 8013222C 0C001260 */       jal func_80004980
  ...
  /* 12AC08 80132248 0C033781 */       jal func_ovl0_800CDE04
  ...
  /* 12AC7C 801322BC 0C001260 */       jal func_80004980
