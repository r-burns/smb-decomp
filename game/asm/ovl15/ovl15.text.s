...
glabel func_ovl15_800D64C4
  /* 150774 800D64C4 3C0E8004 */       lui $t6, %hi(D_80045472)
  /* 150778 800D64C8 95CE5472 */       lhu $t6, %lo(D_80045472)($t6)
  ...
  /* 1507C8 800D6518 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 1507CC 800D651C 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 1507D0 800D6520 90480000 */       lbu $t0, ($v0) # D_800A4AD0 + 0
  /* 1507D4 800D6524 24090004 */     addiu $t1, $zero, 4
  /* 1507D8 800D6528 A0490000 */        sb $t1, ($v0) # D_800A4AD0 + 0
  /* 1507DC 800D652C 0C00171D */       jal func_80005C74
  /* 1507E0 800D6530 A0480001 */        sb $t0, 1($v0) # D_800A4AD0 + 1
...
glabel func_ovl15_800D660C
  ...
  /* 1508D4 800D6624 0C00265A */       jal func_80009968
