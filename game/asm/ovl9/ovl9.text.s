...
glabel func_ovl9_80369240
  /* 1AB6B0 80369240 3C038004 */       lui $v1, %hi(D_80045478)
  /* 1AB6B4 80369244 80635478 */        lb $v1, %lo(D_80045478)($v1)
  ...
  /* 1AB6D8 80369268 3C038004 */       lui $v1, %hi(D_80045479)
  /* 1AB6DC 8036926C 34420200 */       ori $v0, $v0, 0x200
  /* 1AB6E0 80369270 3042FFFF */      andi $v0, $v0, 0xffff
  .L80369274:
  /* 1AB6E4 80369274 80635479 */        lb $v1, %lo(D_80045479)($v1)
...
glabel func_ovl9_8036975C
  ...
  /* 1ABBDC 8036976C 3C048004 */       lui $a0, %hi(D_80045474)
  /* 1ABBE0 80369770 94845474 */       lhu $a0, %lo(D_80045474)($a0)
  ...
  /* 1ABD48 803698D8 3C048004 */       lui $a0, %hi(D_80045474)
  /* 1ABD4C 803698DC 1000004A */         b jtgt_ovl9_80369A08
  /* 1ABD50 803698E0 94845474 */       lhu $a0, %lo(D_80045474)($a0)
  ...
  /* 1ABD88 80369918 3C048004 */       lui $a0, %hi(D_80045474)
  ...
  /* 1ABE2C 803699BC 94845474 */       lhu $a0, %lo(D_80045474)($a0)
  ...
  /* 1ABE4C 803699DC 3C048004 */       lui $a0, %hi(D_80045474)
  ...
  /* 1ABE74 80369A04 94845474 */       lhu $a0, %lo(D_80045474)($a0)
  ...
  /* 1AC03C 80369BCC 3C028004 */       lui $v0, %hi(D_80045478)
  /* 1AC040 80369BD0 80425478 */        lb $v0, %lo(D_80045478)($v0)
  /* 1AC044 80369BD4 3C0E8004 */       lui $t6, %hi(D_80045472)
  ...
  .L80369C90:
  /* 1AC100 80369C90 95CE5472 */       lhu $t6, %lo(D_80045472)($t6)
  ...
  .L80369D30:
  /* 1AC1A0 80369D30 3C198004 */       lui $t9, %hi(D_80045472)
  /* 1AC1A4 80369D34 97395472 */       lhu $t9, %lo(D_80045472)($t9)
...
glabel func_ovl9_80369D78
  ...
  /* 1AC2FC 80369E8C 0C002062 */       jal func_80008188
