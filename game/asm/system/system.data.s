...
glabel D_800396C0
  .incbin "system.raw.bin", 0x392C0, 0x20

glabel D_800396E0
  .incbin "system.raw.bin", 0x392E0, 0xC

glabel D_800396EC
  .incbin "system.raw.bin", 0x392EC, 0x10

glabel D_800396FC
  .incbin "system.raw.bin", 0x392FC, 0xC

glabel D_80039708
  .incbin "system.raw.bin", 0x39308, 0x44

glabel D_8003974C
  .incbin "system.raw.bin", 0x3934C, 0xC

glabel D_80039758
  .incbin "system.raw.bin", 0x39358, 0xC
  /* 39364 03A364 80039764 */
  .asciz "#c"
  .balign 4
  .incbin "system.raw.bin", 0x39368, 0x10

glabel D_80039778
  /* 39378 03A378 80039778 */
  .asciz " ~"
  .balign 4
  .incbin "system.raw.bin", 0x3937C, 0x14

glabel D_80039790
  .incbin "system.raw.bin", 0x39390, 0xC

glabel D_8003979C
  .incbin "system.raw.bin", 0x3939C, 0x1C

glabel D_800397B8
  .incbin "system.raw.bin", 0x393B8, 0xC

glabel D_800397C4
  .incbin "system.raw.bin", 0x393C4, 0x6C
  /* 39430 03A430 80039830 */
  .asciz " B"
  .balign 4
  .incbin "system.raw.bin", 0x39434, 0x3C
  /* 39470 03A470 80039870 */
  .asciz " B"
  .balign 4
  .incbin "system.raw.bin", 0x39474, 0x1C
  /* 39490 03A490 80039890 */
  .asciz " B"
  .balign 4
  .incbin "system.raw.bin", 0x39494, 0x138
  /* 395CC 03A5CC 800399CC */
  .asciz " !"
  .balign 4
  .incbin "system.raw.bin", 0x395D0, 0x7C
  /* 3964C 03A64C 80039A4C */
  .asciz "@\r8"
  .balign 4
  .incbin "system.raw.bin", 0x39650, 0x4
  /* 39654 03A654 80039A54 */
  .asciz "@\r8"
  .balign 4
  /* 39658 03A658 80039A58 */
  .asciz "@\r("
  .balign 4
  .incbin "system.raw.bin", 0x3965C, 0x4
  /* 39660 03A660 80039A60 */
  .asciz "@\r("
  .balign 4
  .incbin "system.raw.bin", 0x39664, 0x27C
  /* 398E0 03A8E0 80039CE0 */
  .asciz " B"
  .balign 4
  .incbin "system.raw.bin", 0x398E4, 0x154
  /* 39A38 03AA38 80039E38 */
  .asciz " B"
  .balign 4
  .incbin "system.raw.bin", 0x39A3C, 0x270
  /* 39CAC 03ACAC 8003A0AC */
  .asciz " B"
  .balign 4
  .incbin "system.raw.bin", 0x39CB0, 0x270
