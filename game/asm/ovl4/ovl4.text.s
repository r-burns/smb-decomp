...
glabel func_ovl4_8018D0E0
  ...
  /* 10A014 8018D124 3C15800A */       lui $s5, %hi(D_800A50E8)
  /* 10A018 8018D128 26B550E8 */     addiu $s5, $s5, %lo(D_800A50E8)
  ...
  /* 10A03C 8018D14C 8EA20000 */        lw $v0, ($s5) # D_800A50E8 + 0
...
glabel func_ovl4_8018D228
  ...
  /* 10A11C 8018D22C 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 10A120 8018D230 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  ...
  /* 10A13C 8018D24C A0400012 */        sb $zero, 0x12($v0) # D_800A4AD0 + 18
  /* 10A140 8018D250 0C0638CC */       jal func_ovl4_8018E330
  /* 10A144 8018D254 A0400010 */        sb $zero, 0x10($v0) # D_800A4AD0 + 16
  /* 10A148 8018D258 3C13800A */       lui $s3, %hi(D_800A44E0)
  /* 10A14C 8018D25C 267344E0 */     addiu $s3, $s3, %lo(D_800A44E0)
  /* 10A150 8018D260 926E05E2 */       lbu $t6, 0x5e2($s3) # D_800A44E0 + 1506
  ...
  /* 10A160 8018D270 927805E3 */       lbu $t8, 0x5e3($s3) # D_800A44E0 + 1507
  ...
  /* 10A1E0 8018D2F0 926A05E2 */       lbu $t2, 0x5e2($s3) # D_800A44E0 + 1506
  /* 10A1E4 8018D2F4 354B0004 */       ori $t3, $t2, 4
  /* 10A1E8 8018D2F8 A26B05E2 */        sb $t3, 0x5e2($s3) # D_800A44E0 + 1506
  ...
  /* 10A24C 8018D35C 0C05B7A8 */       jal func_ovl3_8016DEA0
  ...
  /* 10A290 8018D3A0 3C12800A */       lui $s2, %hi(D_800A50E8)
  /* 10A294 8018D3A4 265250E8 */     addiu $s2, $s2, %lo(D_800A50E8)
  ...
  /* 10A2E8 8018D3F8 8E480000 */        lw $t0, ($s2) # D_800A50E8 + 0
  /* 10A2EC 8018D3FC 3C0B8004 */       lui $t3, %hi(D_80045228)
  /* 10A2F0 8018D400 24010002 */     addiu $at, $zero, 2
  /* 10A2F4 8018D404 01111821 */      addu $v1, $t0, $s1
  /* 10A2F8 8018D408 90690022 */       lbu $t1, 0x22($v1)
  /* 10A2FC 8018D40C 256B5228 */     addiu $t3, $t3, %lo(D_80045228)
  ...
  /* 10A314 8018D424 8E4C0000 */        lw $t4, ($s2) # D_800A50E8 + 0
  ...
  /* 10A338 8018D448 8E450000 */        lw $a1, ($s2) # D_800A50E8 + 0
...
glabel func_ovl4_8018D5E0
  ...
  /* 10A4D4 8018D5E4 3C0D800A */       lui $t5, %hi(D_800A50E8)
  /* 10A4D8 8018D5E8 8DAD50E8 */        lw $t5, %lo(D_800A50E8)($t5)
  ...
  /* 10A544 8018D654 3C05800A */       lui $a1, %hi(D_800A50C8)
  ...
  /* 10A554 8018D664 24A550C8 */     addiu $a1, $a1, %lo(D_800A50C8)
  ...
  /* 10A808 8018D918 A0AE0022 */        sb $t6, 0x22($a1) # D_800A50C8 + 34
...
glabel func_ovl4_8018DE20
  ...
  /* 10AD18 8018DE28 3C01800A */       lui $at, %hi(D_800A4AE2)
  ...
  /* 10AD34 8018DE44 A0204AE2 */        sb $zero, %lo(D_800A4AE2)($at)
  ...
  /* 10AD98 8018DEA8 0C05B7A8 */       jal func_ovl3_8016DEA0
  ...
  /* 10ADDC 8018DEEC 3C12800A */       lui $s2, %hi(D_800A50E8)
  /* 10ADE0 8018DEF0 265250E8 */     addiu $s2, $s2, %lo(D_800A50E8)
  ...
  /* 10AE34 8018DF44 8E4A0000 */        lw $t2, ($s2) # D_800A50E8 + 0
  /* 10AE38 8018DF48 3C0D8004 */       lui $t5, %hi(D_80045228)
  /* 10AE3C 8018DF4C 24010002 */     addiu $at, $zero, 2
  /* 10AE40 8018DF50 01512821 */      addu $a1, $t2, $s1
  /* 10AE44 8018DF54 90AB0022 */       lbu $t3, 0x22($a1)
  /* 10AE48 8018DF58 25AD5228 */     addiu $t5, $t5, %lo(D_80045228)
  ...
  /* 10AE60 8018DF70 8E4E0000 */        lw $t6, ($s2) # D_800A50E8 + 0
  ...
  /* 10AE84 8018DF94 8E430000 */        lw $v1, ($s2) # D_800A50E8 + 0
  ...
  /* 10AF2C 8018E03C 8E4C0000 */        lw $t4, ($s2) # D_800A50E8 + 0
...
glabel vs_battle_entry
  /* 10B080 8018E190 3C02800A */       lui $v0, %hi(D_800A50E8)
  /* 10B084 8018E194 3C0E800A */       lui $t6, %hi(D_800A4D08)
  /* 10B088 8018E198 244250E8 */     addiu $v0, $v0, %lo(D_800A50E8)
  ...
  /* 10B098 8018E1A8 AC4E0000 */        sw $t6, ($v0) # D_800A50E8 + 0
  /* 10B09C 8018E1AC 240F0001 */     addiu $t7, $zero, 1
  /* 10B0A0 8018E1B0 A1CF0000 */        sb $t7, ($t6) # D_800A4D08 + 0
  /* 10B0A4 8018E1B4 3C19800A */       lui $t9, %hi(D_800A4ADF)
  /* 10B0A8 8018E1B8 93394ADF */       lbu $t9, %lo(D_800A4ADF)($t9)
  /* 10B0AC 8018E1BC 8C480000 */        lw $t0, ($v0) # D_800A50E8 + 0
  /* 10B0B0 8018E1C0 3C09800A */       lui $t1, %hi(D_800A4AC2)
  /* 10B0B4 8018E1C4 3C048019 */       lui $a0, %hi(D_ovl4_8018E3D8)
  /* 10B0B8 8018E1C8 A1190001 */        sb $t9, 1($t0)
  /* 10B0BC 8018E1CC 91294AC2 */       lbu $t1, %lo(D_800A4AC2)($t1)
  ...
  /* 10B0D4 8018E1E4 8C4B0000 */        lw $t3, ($v0) # D_800A50E8 + 0
  ...
  /* 10B15C 8018E26C 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 10B160 8018E270 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 10B164 8018E274 90480012 */       lbu $t0, 0x12($v0) # D_800A4AD0 + 18
  ...
  /* 10B180 8018E290 3C02800A */       lui $v0, %hi(D_800A50E8)
  /* 10B184 8018E294 3C09800A */       lui $t1, %hi(D_800A4EF8)
  /* 10B188 8018E298 244250E8 */     addiu $v0, $v0, %lo(D_800A50E8)
  /* 10B18C 8018E29C 25294EF8 */     addiu $t1, $t1, %lo(D_800A4EF8)
  /* 10B190 8018E2A0 AC490000 */        sw $t1, ($v0) # D_800A50E8 + 0
  ...
  .L8018E304:
  /* 10B1F4 8018E304 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 10B1F8 8018E308 8FBF0014 */        lw $ra, 0x14($sp)
  /* 10B1FC 8018E30C 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 10B200 8018E310 904D0000 */       lbu $t5, ($v0) # D_800A4AD0 + 0
  /* 10B204 8018E314 240E0018 */     addiu $t6, $zero, 0x18
  /* 10B208 8018E318 A04E0000 */        sb $t6, ($v0) # D_800A4AD0 + 0
  /* 10B20C 8018E31C 27BD0018 */     addiu $sp, $sp, 0x18
  /* 10B210 8018E320 03E00008 */        jr $ra
  /* 10B214 8018E324 A04D0001 */        sb $t5, 1($v0) # D_800A4AD0 + 1
