...
glabel func_ovl64_8018D0E0
  ...
  /* 18BE28 8018D0E8 3C108004 */       lui $s0, %hi(D_800466FC)
  /* 18BE2C 8018D0EC 8E1066FC */        lw $s0, %lo(D_800466FC)($s0)
  ...
  .L8018D110:
  /* 18BE50 8018D110 3C0F800A */       lui $t7, %hi(D_800A50E8)
  /* 18BE54 8018D114 8DEF50E8 */        lw $t7, %lo(D_800A50E8)($t7)
...
glabel func_ovl64_8018D134
  ...
  /* 18BE78 8018D138 3C028004 */       lui $v0, %hi(D_80045228)
  /* 18BE7C 8018D13C 3C048004 */       lui $a0, %hi(D_80045250)
  /* 18BE80 8018D140 AFBF0014 */        sw $ra, 0x14($sp)
  /* 18BE84 8018D144 24845250 */     addiu $a0, $a0, %lo(D_80045250)
  /* 18BE88 8018D148 24425228 */     addiu $v0, $v0, %lo(D_80045228)
  /* 18BE8C 8018D14C 94430002 */       lhu $v1, 2($v0) # D_80045228 + 2
  .L8018D150:
  ...
  /* 18BEA0 8018D160 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 18BEA4 8018D164 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 18BEA8 8018D168 904F0000 */       lbu $t7, ($v0) # D_800A4AD0 + 0
  /* 18BEAC 8018D16C 24180001 */     addiu $t8, $zero, 1
  /* 18BEB0 8018D170 A0580000 */        sb $t8, ($v0) # D_800A4AD0 + 0
  /* 18BEB4 8018D174 0C00171D */       jal func_80005C74
  /* 18BEB8 8018D178 A04F0001 */        sb $t7, 1($v0) # D_800A4AD0 + 1
...
glabel func_ovl64_8018D2CC
  /* 18C00C 8018D2CC 3C05800A */       lui $a1, %hi(D_800A50E8)
  /* 18C010 8018D2D0 24A550E8 */     addiu $a1, $a1, %lo(D_800A50E8)
  /* 18C014 8018D2D4 8CAE0000 */        lw $t6, ($a1) # D_800A50E8 + 0
  ...
  /* 18C034 8018D2F4 3C05800A */       lui $a1, %hi(D_800A50E8)
  /* 18C038 8018D2F8 10400004 */      beqz $v0, .L8018D30C
  /* 18C03C 8018D2FC 24A550E8 */     addiu $a1, $a1, %lo(D_800A50E8)
  ...
  .L8018D30C:
  /* 18C04C 8018D30C 8CB80000 */        lw $t8, ($a1) # D_800A50E8 + 0
  ...
  /* 18C060 8018D320 8CA20000 */        lw $v0, ($a1) # D_800A50E8 + 0
  ...
  /* 18C07C 8018D33C 8CAD0000 */        lw $t5, ($a1) # D_800A50E8 + 0
  ...
  /* 18C0DC 8018D39C 3C0E800A */       lui $t6, %hi(D_800A50E8)
  /* 18C0E0 8018D3A0 8DCE50E8 */        lw $t6, %lo(D_800A50E8)($t6)
  ...
  /* 18C114 8018D3D4 3C06800A */       lui $a2, %hi(D_800A50E8)
  /* 18C118 8018D3D8 24C650E8 */     addiu $a2, $a2, %lo(D_800A50E8)
  /* 18C11C 8018D3DC 8CC20000 */        lw $v0, ($a2) # D_800A50E8 + 0
  ...
  /* 18C178 8018D438 3C06800A */       lui $a2, %hi(D_800A50E8)
  /* 18C17C 8018D43C 10400004 */      beqz $v0, .L8018D450
  /* 18C180 8018D440 24C650E8 */     addiu $a2, $a2, %lo(D_800A50E8)
  ...
  .L8018D450:
  /* 18C190 8018D450 8CCC0000 */        lw $t4, ($a2) # D_800A50E8 + 0
  ...
  /* 18C1D4 8018D494 8CCE0000 */        lw $t6, ($a2) # D_800A50E8 + 0
  ...
  /* 18C230 8018D4F0 3C0E800A */       lui $t6, %hi(D_800A50E8)
  /* 18C234 8018D4F4 8DCE50E8 */        lw $t6, %lo(D_800A50E8)($t6)
  ...
  /* 18C268 8018D528 3C06800A */       lui $a2, %hi(D_800A50E8)
  /* 18C26C 8018D52C 24C650E8 */     addiu $a2, $a2, %lo(D_800A50E8)
  /* 18C270 8018D530 8CCE0000 */        lw $t6, ($a2) # D_800A50E8 + 0
  ...
  /* 18C288 8018D548 3C06800A */       lui $a2, %hi(D_800A50E8)
  /* 18C28C 8018D54C 24C650E8 */     addiu $a2, $a2, %lo(D_800A50E8)
  /* 18C290 8018D550 8CD90000 */        lw $t9, ($a2) # D_800A50E8 + 0
  ...
  /* 18C2AC 8018D56C 8CC30000 */        lw $v1, ($a2) # D_800A50E8 + 0
  ...
  /* 18C2D0 8018D590 8CCF0000 */        lw $t7, ($a2) # D_800A50E8 + 0
...
glabel func_ovl64_8018D5F0
  /* 18C330 8018D5F0 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 18C334 8018D5F4 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 18C338 8018D5F8 904E0000 */       lbu $t6, ($v0) # D_800A4AD0 + 0
  ...
  /* 18C348 8018D608 A04F0000 */        sb $t7, ($v0) # D_800A4AD0 + 0
  /* 18C34C 8018D60C 0C00171D */       jal func_80005C74
  /* 18C350 8018D610 A04E0001 */        sb $t6, 1($v0) # D_800A4AD0 + 1
...
glabel func_ovl64_8018D990
  ...
  /* 18C748 8018DA08 904A0040 */       lbu $t2, 0x40($v0) # D_800A4AD0 + 64
  /* 18C74C 8018DA0C 904D0040 */       lbu $t5, 0x40($v0) # D_800A4AD0 + 64
  /* 18C750 8018DA10 AE430000 */        sw $v1, ($s2) # D_800A50E8 + 0
  ...
  /* 18C76C 8018DA2C A0480040 */        sb $t0, 0x40($v0) # D_800A4AD0 + 64
  /* 18C770 8018DA30 14200002 */      bnez $at, .L8018DA3C
  /* 18C774 8018DA34 A06B0001 */        sb $t3, 1($v1) # D_ovl64_8018E2F0 + 1
  /* 18C778 8018DA38 A0400040 */        sb $zero, 0x40($v0) # D_800A4AD0 + 64
  .L8018DA3C:
  /* 18C77C 8018DA3C 9059000E */       lbu $t9, 0xe($v0) # D_800A4AD0 + 14
  /* 18C780 8018DA40 9049000D */       lbu $t1, 0xd($v0) # D_800A4AD0 + 13
  ...
  .L8018DA6C:
  /* 18C7AC 8018DA6C 8E4D0000 */        lw $t5, ($s2) # D_800A50E8 + 0
  ...
  /* 18C7E0 8018DAA0 8E490000 */        lw $t1, ($s2) # D_800A50E8 + 0
  ...
  /* 18C7FC 8018DABC 8E4B0000 */        lw $t3, ($s2) # D_800A50E8 + 0
  ...
  /* 18C80C 8018DACC 8E4D0000 */        lw $t5, ($s2) # D_800A50E8 + 0
...
glabel func_ovl64_8018DB18
  ...
  /* 18C910 8018DBD0 3C15800A */       lui $s5, %hi(D_800A50E8)
  ...
  /* 18C920 8018DBE0 26B550E8 */     addiu $s5, $s5, %lo(D_800A50E8)
  ...
  .L8018DBF4:
  /* 18C934 8018DBF4 8EAF0000 */        lw $t7, ($s5) # D_800A50E8 + 0
...
glabel func_ovl64_8018DCC4
  ...
  /* 18CA8C 8018DD4C 0C05B7A8 */       jal func_ovl3_8016DEA0
  ...
  /* 18CAD0 8018DD90 3C138004 */       lui $s3, %hi(D_80045228)
  /* 18CAD4 8018DD94 3C12800A */       lui $s2, %hi(D_800A50E8)
  /* 18CAD8 8018DD98 265250E8 */     addiu $s2, $s2, %lo(D_800A50E8)
  /* 18CADC 8018DD9C 26735228 */     addiu $s3, $s3, %lo(D_80045228)
  ...
  /* 18CB28 8018DDE8 8E4A0000 */        lw $t2, ($s2) # D_800A50E8 + 0
  ...
  /* 18CB38 8018DDF8 8E4C0000 */        lw $t4, ($s2) # D_800A50E8 + 0
  ...
  .L8018DE44:
  /* 18CB84 8018DE44 8E430000 */        lw $v1, ($s2) # D_800A50E8 + 0
  ...
  /* 18CC18 8018DED8 8E4D0000 */        lw $t5, ($s2) # D_800A50E8 + 0
  ...
  /* 18CC2C 8018DEEC 8E490000 */        lw $t1, ($s2) # D_800A50E8 + 0
...
glabel func_ovl64_8018E0C0
  ...
  /* 18CE50 8018E110 0C0337DE */       jal func_ovl0_800CDF78
  ...
  /* 18CE60 8018E120 0C0337BB */       jal func_ovl0_800CDEEC
  /* 18CE64 8018E124 24050008 */     addiu $a1, $zero, 8
  /* 18CE68 8018E128 00402025 */        or $a0, $v0, $zero
  /* 18CE6C 8018E12C 0C001260 */       jal func_80004980
  ...
  /* 18CE88 8018E148 0C033781 */       jal func_ovl0_800CDE04
