...
glabel func_ovl63_8018D14C
  ...
  /* 18A7BC 8018D1AC AC620000 */        sw $v0, ($v1) # D_800A50E8 + 0
...
glabel func_ovl63_8018D1D4
  ...
  .L8018D224:
  /* 18A834 8018D224 3C08800A */       lui $t0, %hi(D_800A50E8)
  /* 18A838 8018D228 8D0850E8 */        lw $t0, %lo(D_800A50E8)($t0)
...
glabel func_ovl63_8018D2D0
  /* 18A8E0 8018D2D0 3C058004 */       lui $a1, %hi(D_800465B0)
  /* 18A8E4 8018D2D4 24A565B0 */     addiu $a1, $a1, %lo(D_800465B0)
  /* 18A8E8 8018D2D8 8CA30000 */        lw $v1, ($a1) # D_800465B0 + 0
  ...
  /* 18A91C 8018D30C ACB80000 */        sw $t8, ($a1) # D_800465B0 + 0
  ...
  /* 18A930 8018D320 8CA30000 */        lw $v1, ($a1) # D_800465B0 + 0
  ...
  /* 18A9AC 8018D39C ACAA0000 */        sw $t2, ($a1) # D_800465B0 + 0
  ...
  /* 18A9C0 8018D3B0 8CA30000 */        lw $v1, ($a1) # D_800465B0 + 0
  /* 18A9C4 8018D3B4 3C0EE700 */       lui $t6, 0xe700
  /* 18A9C8 8018D3B8 246D0008 */     addiu $t5, $v1, 8
  /* 18A9CC 8018D3BC ACAD0000 */        sw $t5, ($a1) # D_800465B0 + 0
...
glabel func_ovl63_8018D5FC
  /* 18AC0C 8018D5FC 3C038004 */       lui $v1, %hi(D_800465B0)
  /* 18AC10 8018D600 246365B0 */     addiu $v1, $v1, %lo(D_800465B0)
  /* 18AC14 8018D604 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  /* 18AC18 8018D608 27BDFFE8 */     addiu $sp, $sp, -0x18
  /* 18AC1C 8018D60C AFBF0014 */        sw $ra, 0x14($sp)
  /* 18AC20 8018D610 244E0008 */     addiu $t6, $v0, 8
  /* 18AC24 8018D614 AC6E0004 */        sw $t6, 4($v1) # D_800465B0 + 4
  /* 18AC28 8018D618 3C0FE700 */       lui $t7, 0xe700
  /* 18AC2C 8018D61C AC4F0000 */        sw $t7, ($v0)
  /* 18AC30 8018D620 AC400004 */        sw $zero, 4($v0)
  /* 18AC34 8018D624 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AC44 8018D634 AC780004 */        sw $t8, 4($v1) # D_800465B0 + 4
  /* 18AC48 8018D638 AC400004 */        sw $zero, 4($v0)
  /* 18AC4C 8018D63C AC590000 */        sw $t9, ($v0)
  /* 18AC50 8018D640 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AC60 8018D650 AC680004 */        sw $t0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AC78 8018D668 3C038004 */       lui $v1, %hi(D_800465B0)
  /* 18AC7C 8018D66C 246365B0 */     addiu $v1, $v1, %lo(D_800465B0)
  /* 18AC80 8018D670 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AC90 8018D680 AC6B0004 */        sw $t3, 4($v1) # D_800465B0 + 4
  /* 18AC94 8018D684 AC400004 */        sw $zero, 4($v0)
  /* 18AC98 8018D688 AC4C0000 */        sw $t4, ($v0)
  /* 18AC9C 8018D68C 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18ACAC 8018D69C AC6D0004 */        sw $t5, 4($v1) # D_800465B0 + 4
  /* 18ACB0 8018D6A0 AC4F0004 */        sw $t7, 4($v0)
  /* 18ACB4 8018D6A4 AC4E0000 */        sw $t6, ($v0)
  /* 18ACB8 8018D6A8 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18ACC8 8018D6B8 AC780004 */        sw $t8, 4($v1) # D_800465B0 + 4
...
glabel func_ovl63_8018D748
  ...
  /* 18AD70 8018D760 0C00265A */       jal func_80009968
  ...
  /* 18ADF4 8018D7E4 0C002062 */       jal func_80008188
...
glabel func_ovl63_8018D808
  /* 18AE18 8018D808 3C038004 */       lui $v1, %hi(D_800465B0)
  /* 18AE1C 8018D80C 246365B0 */     addiu $v1, $v1, %lo(D_800465B0)
  /* 18AE20 8018D810 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  /* 18AE24 8018D814 27BDFFE8 */     addiu $sp, $sp, -0x18
  /* 18AE28 8018D818 AFBF0014 */        sw $ra, 0x14($sp)
  /* 18AE2C 8018D81C 244E0008 */     addiu $t6, $v0, 8
  /* 18AE30 8018D820 AC6E0004 */        sw $t6, 4($v1) # D_800465B0 + 4
  /* 18AE34 8018D824 3C0FE700 */       lui $t7, 0xe700
  /* 18AE38 8018D828 AC4F0000 */        sw $t7, ($v0)
  /* 18AE3C 8018D82C AC400004 */        sw $zero, 4($v0)
  /* 18AE40 8018D830 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AE50 8018D840 AC780004 */        sw $t8, 4($v1) # D_800465B0 + 4
  /* 18AE54 8018D844 AC400004 */        sw $zero, 4($v0)
  /* 18AE58 8018D848 AC590000 */        sw $t9, ($v0)
  /* 18AE5C 8018D84C 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AE6C 8018D85C AC680004 */        sw $t0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AE84 8018D874 3C038004 */       lui $v1, %hi(D_800465B0)
  /* 18AE88 8018D878 246365B0 */     addiu $v1, $v1, %lo(D_800465B0)
  /* 18AE8C 8018D87C 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AE9C 8018D88C AC6B0004 */        sw $t3, 4($v1) # D_800465B0 + 4
  /* 18AEA0 8018D890 AC400004 */        sw $zero, 4($v0)
  /* 18AEA4 8018D894 AC4C0000 */        sw $t4, ($v0)
  /* 18AEA8 8018D898 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AEB8 8018D8A8 AC6D0004 */        sw $t5, 4($v1) # D_800465B0 + 4
  /* 18AEBC 8018D8AC AC4F0004 */        sw $t7, 4($v0)
  /* 18AEC0 8018D8B0 AC4E0000 */        sw $t6, ($v0)
  /* 18AEC4 8018D8B4 8C620004 */        lw $v0, 4($v1) # D_800465B0 + 4
  ...
  /* 18AED4 8018D8C4 AC780004 */        sw $t8, 4($v1) # D_800465B0 + 4
...
glabel func_ovl63_8018DA04
  ...
  /* 18B02C 8018DA1C 0C00265A */       jal func_80009968
  ...
  /* 18B0B0 8018DAA0 0C002062 */       jal func_80008188
...
glabel func_ovl63_8018DB44
  ...
  /* 18B16C 8018DB5C 0C00265A */       jal func_80009968
...
glabel func_ovl63_8018DC0C
  ...
  /* 18B234 8018DC24 0C00265A */       jal func_80009968
...
glabel func_ovl63_8018DF18
  ...
  /* 18B52C 8018DF1C 3C028004 */       lui $v0, %hi(D_80045228)
  /* 18B530 8018DF20 3C048004 */       lui $a0, %hi(D_80045250)
  /* 18B534 8018DF24 AFBF0014 */        sw $ra, 0x14($sp)
  /* 18B538 8018DF28 24845250 */     addiu $a0, $a0, %lo(D_80045250)
  /* 18B53C 8018DF2C 24425228 */     addiu $v0, $v0, %lo(D_80045228)
  /* 18B540 8018DF30 94430002 */       lhu $v1, 2($v0) # D_80045228 + 2
  .L8018DF34:
...
glabel func_ovl63_8018E13C
  ...
  /* 18B760 8018E150 0C00265A */       jal func_80009968
  ...
  /* 18B77C 8018E16C 0C002062 */       jal func_80008188
...
glabel func_ovl63_8018E1A0
  ...
  /* 18B830 8018E220 0C05B7A8 */       jal func_ovl3_8016DEA0
  ...
  /* 18B84C 8018E23C 0C05952C */       jal func_ovl3_801654B0
  /* 18B850 8018E240 00000000 */       nop 
  /* 18B854 8018E244 0C03F4C0 */       jal func_ovl2_800FD300
  ...
  /* 18B874 8018E264 3C13800A */       lui $s3, %hi(D_800A50E8)
  /* 18B878 8018E268 267350E8 */     addiu $s3, $s3, %lo(D_800A50E8)
  ...
  /* 18B8CC 8018E2BC 8E690000 */        lw $t1, ($s3) # D_800A50E8 + 0
  /* 18B8D0 8018E2C0 3C0C8004 */       lui $t4, %hi(D_80045228)
  /* 18B8D4 8018E2C4 24010002 */     addiu $at, $zero, 2
  /* 18B8D8 8018E2C8 01311021 */      addu $v0, $t1, $s1
  /* 18B8DC 8018E2CC 904A0022 */       lbu $t2, 0x22($v0)
  /* 18B8E0 8018E2D0 258C5228 */     addiu $t4, $t4, %lo(D_80045228)
  ...
  /* 18B908 8018E2F8 8E6E0000 */        lw $t6, ($s3) # D_800A50E8 + 0
  ...
  .L8018E344:
  /* 18B954 8018E344 8E630000 */        lw $v1, ($s3) # D_800A50E8 + 0
  ...
  /* 18B9C8 8018E3B8 0C035FCF */       jal func_ovl2_800D7F3C
  /* 18B9CC 8018E3BC 02A02025 */        or $a0, $s5, $zero
  /* 18B9D0 8018E3C0 8E6B0000 */        lw $t3, ($s3) # D_800A50E8 + 0
  ...
  /* 18B9E4 8018E3D4 8E6D0000 */        lw $t5, ($s3) # D_800A50E8 + 0
...
glabel func_ovl63_8018E51C
  ...
  /* 18BB4C 8018E53C 3C058013 */       lui $a1, %hi(D_ovl2_80131390)
  /* 18BB50 8018E540 3C068013 */       lui $a2, %hi(D_ovl2_80131394)
  /* 18BB54 8018E544 AC780004 */        sw $t8, 4($v1)
  /* 18BB58 8018E548 AC6F0000 */        sw $t7, ($v1)
  /* 18BB5C 8018E54C 8CC61394 */        lw $a2, %lo(D_ovl2_80131394)($a2)
  /* 18BB60 8018E550 0C03F2DC */       jal func_ovl2_800FCB70
  /* 18BB64 8018E554 8CA51390 */        lw $a1, %lo(D_ovl2_80131390)($a1)
...
glabel func_ovl63_8018E640
  ...
  /* 18BCA0 8018E690 0C0337DE */       jal func_ovl0_800CDF78
  ...
  /* 18BCB0 8018E6A0 0C0337BB */       jal func_ovl0_800CDEEC
  /* 18BCB4 8018E6A4 24050008 */     addiu $a1, $zero, 8
  /* 18BCB8 8018E6A8 00402025 */        or $a0, $v0, $zero
  /* 18BCBC 8018E6AC 0C001260 */       jal func_80004980
  ...
  /* 18BCD8 8018E6C8 0C033781 */       jal func_ovl0_800CDE04
