...
glabel func_ovl16_800D655C
  /* 18D0FC 800D655C 3C028004 */       lui $v0, %hi(D_80045472)
  /* 18D100 800D6560 94425472 */       lhu $v0, %lo(D_80045472)($v0)
  ...
  /* 18D118 800D6578 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 18D11C 800D657C 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 18D120 800D6580 904F0000 */       lbu $t7, ($v0) # D_800A4AD0 + 0
  /* 18D124 800D6584 24180001 */     addiu $t8, $zero, 1
  /* 18D128 800D6588 A0580000 */        sb $t8, ($v0) # D_800A4AD0 + 0
  /* 18D12C 800D658C 0C00171D */       jal func_80005C74
  /* 18D130 800D6590 A04F0001 */        sb $t7, 1($v0) # D_800A4AD0 + 1
  /* 18D134 800D6594 3C028004 */       lui $v0, %hi(D_80045472)
  /* 18D138 800D6598 94425472 */       lhu $v0, %lo(D_80045472)($v0)
  .L800D659C:
...
glabel func_ovl16_800D65C4
  ...
  /* 18D1B8 800D6618 0C0337DE */       jal func_ovl0_800CDF78
  ...
  /* 18D1CC 800D662C 0C0337BB */       jal func_ovl0_800CDEEC
  /* 18D1D0 800D6630 24050001 */     addiu $a1, $zero, 1
  /* 18D1D4 800D6634 00402025 */        or $a0, $v0, $zero
  /* 18D1D8 800D6638 0C001260 */       jal func_80004980
  ...
  /* 18D1F4 800D6654 0C033781 */       jal func_ovl0_800CDE04
  ...
  /* 18D210 800D6670 0C00265A */       jal func_80009968
