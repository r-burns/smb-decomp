...
glabel func_ovl57_80131B6C
  ...
  /* 17E594 80131B84 3C128004 */       lui $s2, %hi(D_80045228)
  /* 17E598 80131B88 00808825 */        or $s1, $a0, $zero
  /* 17E59C 80131B8C AFBF002C */        sw $ra, 0x2c($sp)
  /* 17E5A0 80131B90 26525228 */     addiu $s2, $s2, %lo(D_80045228)
...
glabel func_ovl57_80131C04
  ...
  /* 17E71C 80131D0C 0C0337DE */       jal func_ovl0_800CDF78
  ...
  /* 17E734 80131D24 0C00265A */       jal func_80009968
  ...
  /* 17E7EC 80131DDC 0C00265A */       jal func_80009968
  ...
  /* 17E858 80131E48 0C033722 */       jal func_ovl0_800CDC88
  ...
  /* 17E8E8 80131ED8 0C033722 */       jal func_ovl0_800CDC88
  ...
  /* 17E92C 80131F1C 3C18800A */       lui $t8, %hi(D_800A4AF0)
  /* 17E930 80131F20 E44A0058 */      swc1 $f10, 0x58($v0)
  /* 17E934 80131F24 E450005C */      swc1 $f16, 0x5c($v0)
  /* 17E938 80131F28 8F184AF0 */        lw $t8, %lo(D_800A4AF0)($t8)
...
glabel func_ovl57_80131F60
  ...
  /* 17E9CC 80131FBC 3C02800A */       lui $v0, %hi(D_800A4AD0)
  /* 17E9D0 80131FC0 24424AD0 */     addiu $v0, $v0, %lo(D_800A4AD0)
  /* 17E9D4 80131FC4 90480000 */       lbu $t0, ($v0) # D_800A4AD0 + 0
  /* 17E9D8 80131FC8 24090001 */     addiu $t1, $zero, 1
  /* 17E9DC 80131FCC A0490000 */        sb $t1, ($v0) # D_800A4AD0 + 0
  /* 17E9E0 80131FD0 0C00171D */       jal func_80005C74
  /* 17E9E4 80131FD4 A0480001 */        sb $t0, 1($v0) # D_800A4AD0 + 1
  .L80131FD8:
...
glabel overlay_set55_entry
  ...
  /* 17EA4C 8013203C 3C03800A */       lui $v1, %hi(D_800A4AD0)
  /* 17EA50 80132040 24634AD0 */     addiu $v1, $v1, %lo(D_800A4AD0)
  /* 17EA54 80132044 90620001 */       lbu $v0, 1($v1) # D_800A4AD0 + 1
  ...
  .L80132064:
  /* 17EA74 80132064 906E0014 */       lbu $t6, 0x14($v1) # D_800A4AD0 + 20
  ...
  .L80132074:
  /* 17EA84 80132074 3C0F800A */       lui $t7, %hi(D_800A4D2B)
  /* 17EA88 80132078 91EF4D2B */       lbu $t7, %lo(D_800A4D2B)($t7)
