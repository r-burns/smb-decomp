...
glabel func_ovl7_8018D0C0
  /* 1138E0 8018D0C0 3C028004 */       lui $v0, %hi(D_800466F0 + (0x0E * 4))
  /* 1138E4 8018D0C4 8C426728 */        lw $v0, %lo(D_800466F0 + (0x0E * 4))($v0)
...
glabel func_ovl7_8018D4D0
  /* 113CF0 8018D4D0 3C028004 */       lui $v0, %hi(D_800466F0 + (0x04 * 4))
  /* 113CF4 8018D4D4 8C426700 */        lw $v0, %lo(D_800466F0 + (0x04 * 4))($v0)
...
glabel func_ovl7_801901A0
  ...
  /* 1169C8 801901A8 3C108004 */       lui $s0, %hi(D_800466F0 + (0x03 * 4))
  /* 1169CC 801901AC 8E1066FC */        lw $s0, %lo(D_800466F0 + (0x03 * 4))($s0)
