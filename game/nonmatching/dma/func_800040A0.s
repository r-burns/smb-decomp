...
glabel func_800040A0
  ...
  /* 004CA8 800040A8 3C148004 */       lui $s4, %hi(D_800450F0)
  /* 004CAC 800040AC 269450F0 */     addiu $s4, $s4, %lo(D_800450F0)
  /* 004CB0 800040B0 AFBF002C */        sw $ra, 0x2c($sp)
  /* 004CB4 800040B4 3C058004 */       lui $a1, %hi(D_80045108)
  ...
  /* 004CC8 800040C8 24A55108 */     addiu $a1, $a1, %lo(D_80045108)
  ...
  /* 004CE8 800040E8 3C068004 */       lui $a2, %hi(D_80045178)
  /* 004CEC 800040EC 24C65178 */     addiu $a2, $a2, %lo(D_80045178)
  /* 004CF0 800040F0 02802025 */        or $a0, $s4, $zero
  /* 004CF4 800040F4 0C00C6B8 */       jal osContInit
  /* 004CF8 800040F8 27A50043 */     addiu $a1, $sp, 0x43
  /* 004CFC 800040FC 3C118004 */       lui $s1, %hi(D_80045178)
  /* 004D00 80004100 3C128004 */       lui $s2, %hi(D_800452C8)
  /* 004D04 80004104 265252C8 */     addiu $s2, $s2, %lo(D_800452C8)
  /* 004D08 80004108 26315178 */     addiu $s1, $s1, %lo(D_80045178)
  /* 004D0C 8000410C 00008025 */        or $s0, $zero, $zero
  /* 004D10 80004110 24130068 */     addiu $s3, $zero, 0x68
  .L80004114:
  /* 004D14 80004114 922E0002 */       lbu $t6, 2($s1) # D_80045178 + 2
  ...
  /* 004D9C 8000419C 3C118004 */       lui $s1, %hi(D_80045178)
  /* 004DA0 800041A0 3C058004 */       lui $a1, %hi(D_80045188)
  /* 004DA4 800041A4 3C028004 */       lui $v0, %hi(D_800451A8)
  /* 004DA8 800041A8 3C038004 */       lui $v1, %hi(D_80045228)
  /* 004DAC 800041AC 3C088004 */       lui $t0, %hi(D_80045250)
  /* 004DB0 800041B0 25085250 */     addiu $t0, $t0, %lo(D_80045250)
  /* 004DB4 800041B4 24635228 */     addiu $v1, $v1, %lo(D_80045228)
  /* 004DB8 800041B8 244251A8 */     addiu $v0, $v0, %lo(D_800451A8)
  /* 004DBC 800041BC 24A55188 */     addiu $a1, $a1, %lo(D_80045188)
  /* 004DC0 800041C0 26315178 */     addiu $s1, $s1, %lo(D_80045178)
  /* 004DC4 800041C4 2407001E */     addiu $a3, $zero, 0x1e
  .L800041C8:
  /* 004DC8 800041C8 A040000F */        sb $zero, 0xf($v0) # D_800451A8 + 15
  /* 004DCC 800041CC A0600009 */        sb $zero, 9($v1) # D_80045228 + 9
  /* 004DD0 800041D0 8059000F */        lb $t9, 0xf($v0) # D_800451A8 + 15
  /* 004DD4 800041D4 92290003 */       lbu $t1, 3($s1) # D_80045178 + 3
  /* 004DD8 800041D8 922A0002 */       lbu $t2, 2($s1) # D_80045178 + 2
  /* 004DDC 800041DC 806B0009 */        lb $t3, 9($v1) # D_80045228 + 9
  ...
  /* 004DF0 800041F0 A4A0FFFA */        sh $zero, -6($a1) # D_80045188 + -6
  /* 004DF4 800041F4 A440FFE6 */        sh $zero, -0x1a($v0) # D_800451A8 + -26
  /* 004DF8 800041F8 A440FFE2 */        sh $zero, -0x1e($v0) # D_800451A8 + -30
  /* 004DFC 800041FC A440FFE0 */        sh $zero, -0x20($v0) # D_800451A8 + -32
  /* 004E00 80004200 AC47FFF8 */        sw $a3, -8($v0) # D_800451A8 + -8
  /* 004E04 80004204 AC47FFF0 */        sw $a3, -0x10($v0) # D_800451A8 + -16
  /* 004E08 80004208 AC46FFF4 */        sw $a2, -0xc($v0) # D_800451A8 + -12
  /* 004E0C 8000420C A460FFFA */        sh $zero, -6($v1) # D_80045228 + -6
  /* 004E10 80004210 A460FFF8 */        sh $zero, -8($v1) # D_80045228 + -8
  /* 004E14 80004214 A460FFF6 */        sh $zero, -0xa($v1) # D_80045228 + -10
  /* 004E18 80004218 A059FFEE */        sb $t9, -0x12($v0) # D_800451A8 + -18
  /* 004E1C 8000421C A049FFFC */        sb $t1, -4($v0) # D_800451A8 + -4
  /* 004E20 80004220 A04AFFFD */        sb $t2, -3($v0) # D_800451A8 + -3
  /* 004E24 80004224 1468FFE8 */       bne $v1, $t0, .L800041C8
  /* 004E28 80004228 A06BFFFE */        sb $t3, -2($v1) # D_80045228 + -2
  /* 004E2C 8000422C 0C000F00 */       jal func_80003C00
  /* 004E30 80004230 00000000 */       nop 
  /* 004E34 80004234 3C018004 */       lui $at, %hi(D_80045250)
  /* 004E38 80004238 AC205250 */        sw $zero, %lo(D_80045250)($at)
  /* 004E3C 8000423C 3C018004 */       lui $at, %hi(D_80045254)
  /* 004E40 80004240 AC205254 */        sw $zero, %lo(D_80045254)($at)
  /* 004E44 80004244 24020001 */     addiu $v0, $zero, 1
  /* 004E48 80004248 3C018004 */       lui $at, %hi(D_80045258)
  /* 004E4C 8000424C 8FBF002C */        lw $ra, 0x2c($sp)
  /* 004E50 80004250 3C038004 */       lui $v1, %hi(D_8004525C)
  /* 004E54 80004254 AC225258 */        sw $v0, %lo(D_80045258)($at)
  /* 004E58 80004258 2463525C */     addiu $v1, $v1, %lo(D_8004525C)
  /* 004E5C 8000425C AC620000 */        sw $v0, ($v1) # D_8004525C + 0
  /* 004E60 80004260 3C018004 */       lui $at, %hi(D_80045260)
  ...
  /* 004E78 80004278 AC225260 */        sw $v0, %lo(D_80045260)($at)
