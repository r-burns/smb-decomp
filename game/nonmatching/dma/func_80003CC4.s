...
glabel func_80003CC4
  ...
  /* 0048CC 80003CCC 3C168004 */       lui $s6, %hi(D_800450F0)
  /* 0048D0 80003CD0 26D650F0 */     addiu $s6, $s6, %lo(D_800450F0)
  ...
  /* 004908 80003D08 3C048004 */       lui $a0, %hi(D_80045178)
  /* 00490C 80003D0C 0C00CD71 */       jal osContGetQuery
  /* 004910 80003D10 24845178 */     addiu $a0, $a0, %lo(D_80045178)
  /* 004914 80003D14 3C108004 */       lui $s0, %hi(D_80045178)
  /* 004918 80003D18 3C118004 */       lui $s1, %hi(D_800451A8)
  /* 00491C 80003D1C 3C138004 */       lui $s3, %hi(D_800452C8)
  /* 004920 80003D20 267352C8 */     addiu $s3, $s3, %lo(D_800452C8)
  /* 004924 80003D24 263151A8 */     addiu $s1, $s1, %lo(D_800451A8)
  /* 004928 80003D28 26105178 */     addiu $s0, $s0, %lo(D_80045178)
  ...
  .L80003D38:
  /* 004938 80003D38 92020003 */       lbu $v0, 3($s0) # D_80045178 + 3
  /* 00493C 80003D3C 54400015 */      bnel $v0, $zero, .L80003D94
  /* 004940 80003D40 920A0002 */       lbu $t2, 2($s0) # D_80045178 + 2
  /* 004944 80003D44 920E0002 */       lbu $t6, 2($s0) # D_80045178 + 2
  /* 004948 80003D48 31CF0001 */      andi $t7, $t6, 1
  /* 00494C 80003D4C 51E00011 */      beql $t7, $zero, .L80003D94
  /* 004950 80003D50 920A0002 */       lbu $t2, 2($s0) # D_80045178 + 2
  ...
  /* 00496C 80003D6C 920A0002 */       lbu $t2, 2($s0) # D_80045178 + 2
  .L80003D70:
  ...
  /* 00498C 80003D8C 92020003 */       lbu $v0, 3($s0) # D_80045178 + 3
  /* 004990 80003D90 920A0002 */       lbu $t2, 2($s0) # D_80045178 + 2
  .L80003D94:
