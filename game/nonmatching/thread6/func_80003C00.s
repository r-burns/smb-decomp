...
glabel func_80003C00
  /* 004800 80003C00 3C048004 */       lui $a0, %hi(D_800451A8)
  ...
  /* 004810 80003C10 248451A8 */     addiu $a0, $a0, %lo(D_800451A8)
  /* 004814 80003C14 00001825 */        or $v1, $zero, $zero
  .L80003C18:
  /* 004818 80003C18 908E001C */       lbu $t6, 0x1c($a0) # D_800451A8 + 28
  ...
  /* 00487C 80003C7C A0820000 */        sb $v0, ($a0) # D_800451A8 + 0
  ...
  /* 004898 80003C98 3C038004 */       lui $v1, %hi(D_800451A8)
  /* 00489C 80003C9C 246351A8 */     addiu $v1, $v1, %lo(D_800451A8)
  /* 0048A0 80003CA0 2402FFFF */     addiu $v0, $zero, -1
  .L80003CA4:
  /* 0048A4 80003CA4 24840004 */     addiu $a0, $a0, 4
  /* 0048A8 80003CA8 A082FFFD */        sb $v0, -3($a0) # D_800451A8 + -3
  /* 0048AC 80003CAC A082FFFE */        sb $v0, -2($a0) # D_800451A8 + -2
  /* 0048B0 80003CB0 A082FFFF */        sb $v0, -1($a0) # D_800451A8 + -1
  /* 0048B4 80003CB4 1483FFFB */       bne $a0, $v1, .L80003CA4
  /* 0048B8 80003CB8 A082FFFC */        sb $v0, -4($a0) # D_800451A8 + -4
  .L80003CBC:
